  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex justify-center mb-6">
        <div className="flex bg-newspaper-light-gray rounded-lg p-1">
          <button
            type="button"
            onClick={() => setInputType('text')}
            className={`flex items-center space-x-2 px-4 py-2 rounded-md transition-colors ${
              inputType === 'text'
                ? 'bg-white text-newspaper-black shadow-sm'
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="relative">
          <textarea
            ...
            className="w-full h-32 p-4 newspaper-body text-newspaper-black bg-white newspaper-border resize-none focus:outline-none focus:ring-2 focus:ring-newspaper-black focus:border-transparent"
            required
          />
      ...
      {/* Example Claims */}
      <div className="mt-8 p-6 bg-newspaper-light-gray">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="space-y-2">
            <button
              ...
              className="text-left w-full p-3 bg-white newspaper-border hover:shadow-sm transition-shadow"
            >
